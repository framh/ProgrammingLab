...
class NumericalCSV(fileCSV):
    def __init__(self, nome):
        self.name = nome
    
    def get_data(self):
        float_list = [float(e) for e in i[for i in super().get_data()]]
        
        
n_vendite_shampoo = NumericalCSV('shampoo_sales.csv')
NumericalCSV.get_data(n_vendite_shampoo)
