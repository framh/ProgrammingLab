...
class Studente(Persona):
    ...
    def qualcuno_insegna(self):
        ...
        print(f'questi sono i corsi trovati per {self.nome} {self.cognome} \n')
        return True
...
corsi = ['economia', 'biologia', 'judo', 'bocce']
Michele = Studente('Michele', 'Marrani', corsi)
